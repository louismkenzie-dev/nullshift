  ...
  const load = useCallback(async () => {
    ...
    const [{ data: p }, { data: c }] = await Promise.all([
      supabase
        .from("proposals")
        .select(
          "id,created_at,client_id,title,total,currency,status,accepted_at,project_name,duration,platform,team_size,overview,scope,deliverables,timeline"
        )
    ...
    <div>
      ...
      {loading ? (
        ...
        >
          ...
          >
            No quotes exist yet — create one first.
          </p>
          <Link
            href="/admin/quotes"
            style={{
        ...
        >
          {rows.map((p, i) => {
            ...
            const docComplete = !!(
              doc?.project_name &&
              doc?.overview &&
              doc?.scope?.some((s) => s.items.some((it) => it.trim()))
            );
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{ fontFamily: T.mono, fontSize: "0.9rem", color: T.primary }}
                  >
                  ...
                  <span
                    style={{
                      ...
                      textTransform: "uppercase",
                      color: statusColor[p.status] ?? T.muted,
                    }}
                  >
                    ● {p.status}
                  </span>
                  <span
                    style={{
                      fontFamily: T.mono,
                      fontSize: "10px",
                      color: docComplete ? T.primary : T.accent,
                    }}
                  >
                ...
                {isOpen && doc && (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-5">
                      ...
                      {!accepted && (
                        <button
                          onClick={() => saveDoc(p.id)}
                          disabled={saving === p.id}
                          className="px-5 h-9 transition-opacity hover:opacity-90 disabled:opacity-50"
                          style={{
                            fontFamily: T.mono,
                            fontSize: "0.72rem",
                            letterSpacing: "0.06em",
                    ...
                    <div className="grid gap-3 mb-5">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setDoc(p.id, "project_name", e.target.value)}
                      ...
                      <div className="grid sm:grid-cols-3 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            style={input}
                            value={doc.duration ?? ""}
                            onChange={(e) => setDoc(p.id, "duration", e.target.value)}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            style={input}
                            value={doc.platform ?? ""}
                            onChange={(e) => setDoc(p.id, "platform", e.target.value)}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            style={input}
                            value={doc.team_size ?? ""}
                            onChange={(e) => setDoc(p.id, "team_size", e.target.value)}
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          value={doc.overview ?? ""}
                          onChange={(e) => setDoc(p.id, "overview", e.target.value)}
                                ...
                                {!accepted && (
                                  <button
                                    onClick={() => {
                                      ...
                                      s[pi] = {
                                        ...ph,
                                        items: ph.items.filter((_, j) => j !== ii),
                                      };
                                      setDoc(p.id, "scope", s);
                                    }}
                                    style={{
                    ...
                    <div className="flex flex-col gap-2 mb-5">
                      {doc.deliverables.map((d, di) => (
                        <div key={di} className="flex items-center gap-2">
                          <input
                            ...
                            value={d}
                            onChange={(e) => {
                              const a = [...doc.deliverables];
                              a[di] = e.target.value;
                              setDoc(p.id, "deliverables", a);
                            }}
                            ...
                            <button
                              onClick={() =>
                                setDoc(
                                  p.id,
                                  "deliverables",
                                  doc.deliverables.filter((_, j) => j !== di)
                                )
                              }
                              style={{
                                color: T.danger,
                      ...
                      {!accepted && (
                        <button
                          onClick={() =>
                            setDoc(p.id, "deliverables", [...doc.deliverables, ""])
                          }
                    ...
                    <div className="flex flex-col gap-3 mb-4">
                      {doc.timeline.map((w, wi) => (
                        ...
                        >
                          <input
                            ...
                            value={w.week}
                            onChange={(e) => {
                              const a = [...doc.timeline];
                              a[wi] = { ...w, week: e.target.value };
                              setDoc(p.id, "timeline", a);
                            }}
                            placeholder="Week 1"
                          />
                          <div className="flex flex-col gap-2">
                            ...
                            <textarea
                              ...
                              onChange={(e) => {
                                const a = [...doc.timeline];
                                a[wi] = { ...w, description: e.target.value };
                                setDoc(p.id, "timeline", a);
                              }}
                      ...
                      {!accepted && (
                        <button
                          onClick={() =>
                            setDoc(p.id, "timeline", [
                              ...doc.timeline,
                              {
                                week: `Week ${doc.timeline.length + 1}`,
                                title: "",
                                description: "",
                              },
                            ])
