...
export function ProjectUpdatesSection({ clientId, clientName }: Props) {
  ...
  async function markResolved(id: string) {
    ...
    setUpdates((prev) =>
      prev.map((u) => (u.id === id ? { ...u, action_resolved: true } : u))
    );
  }
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  type === "update"
                    ? "e.g. Wireframes complete"
                    : type === "decision"
                      ? "e.g. Choose your homepage layout"
                  ...
                  {options.map((opt, i) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const o = [...options];
                          o[i] = { ...o[i], image_url: e.target.value };
                          setOptions(o);
                        }}
            ...
            {error && (
              <p style={{ fontFamily: T.sans, fontSize: "0.8rem", color: T.danger }}>
                {error}
              </p>
            )}
      ...
      {loading ? (
        ...
        >
          <p style={{ fontFamily: T.sans, fontSize: "0.875rem", color: T.muted }}>
            No updates yet. Post your first update to keep {clientName} informed on their
            project progress.
          </p>
        </div>
      ) : (
                    ...
                    >
                      ...
                      {update.client_choice ? (
                        <span style={{ color: T.primary }}>
                          {update.options.find((o) => o.id === update.client_choice)
                            ?.label ?? update.client_choice}{" "}
                          ✓
                        </span>
                      ) : (
                  ...
                  {update.requires_action && (
                    <span
                      style={{
                        fontFamily: T.mono,
                        fontSize: "9px",
                        color: update.action_resolved ? T.primary : T.warning,
                      }}
                    >
