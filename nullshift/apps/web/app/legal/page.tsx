...
export default function LegalPage() {
  ...
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="pt-28 pb-12 px-8 md:px-16" style={{ borderBottom: `1px solid ${T.border}` }}>
          <div className="mb-7">
          ...
          <p className="mt-6 max-w-2xl" style={{ fontFamily: T.sans, fontSize: "0.9375rem", lineHeight: 1.65, letterSpacing: "-0.005em", color: T.muted }}>
            How we handle your data and the terms that apply when you use our site and services. Governed by the laws of England and Wales.
          </p>

          {/* Tab switcher — Halo pill tabs */}
          <div className="flex flex-wrap gap-1 mt-10 p-1 w-fit" style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: T.r.full }}>
