...
import { PLAN_META_ONBOARD } from "@nullshift/billing/pricing";
...
function OnboardFlow() {
  ...
  const plan: Plan = (
    rawPlan.toLowerCase() in PLAN_META_ONBOARD ? rawPlan.toLowerCase() : "core"
  ) as Plan;
  ...
  return (
    ...
    >
          ...
          <div key={s} className="flex items-center gap-3">
            ...
            {s < 3 && (
              <div
                className="w-10 h-px"
                style={{
                  background: step > s ? T.primary : T.border,
      ...
      <div className="w-full max-w-md">
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              >
                YOU&apos;VE CHOSEN
                <br />
                <span style={{ color: T.primary }}>{meta.label.toUpperCase()}</span>
              </h1>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              >
                SET UP YOUR
                <br />
                <span style={{ color: T.primary }}>LOGIN</span>
              </h1>
            </div>
            ...
            {!isConfigured ? (
              ...
              >
                <p style={{ fontFamily: T.sans, fontSize: "0.9rem", color: T.muted }}>
                  Supabase is not configured — account creation is unavailable in this
                  environment.
                </p>
                <button
                  onClick={() => setStep(3)}
              ...
              >
                ...
                {error && (
                  <p style={{ fontFamily: T.mono, fontSize: "11px", color: T.danger }}>
                    {error}
                  </p>
                )}
                <button
                  ...
                  style={{
                    ...
                    boxShadow: busy
                      ? "none"
                      : `0 0 20px color-mix(in oklab, ${T.primary} 22%, transparent)`,
                  }}
                >
        ...
        {/* ── Step 3: Payment ── */}
        {step === 3 && <StripeCheckoutRedirect plan={plan} email={email} />}
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        >
          CHECK YOUR
          <br />
          <span style={{ color: T.primary }}>EMAIL</span>
        </h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          {digits.map((d, i) => (
            <input
              ...
              style={{
                ...
                boxShadow: d
                  ? `0 0 12px color-mix(in oklab, ${T.primary} 20%, transparent)`
                  : "none",
              }}
            />
          ))}
        ...
        <button
          ...
          style={{
            ...
            boxShadow: busy
              ? "none"
              : `0 0 24px color-mix(in oklab, ${T.primary} 25%, transparent)`,
          }}
        >
    ...
    return (
      <div className="flex flex-col gap-4 items-center text-center">
        ...
        >
          VERIFYING
          <br />
          <span style={{ color: T.primary }}>YOUR SESSION</span>
        </h1>
        <p style={{ fontFamily: T.sans, fontSize: "0.9rem", color: T.muted }}>
    ...
    return (
      <div className="flex flex-col gap-4 items-center text-center">
        ...
        >
          REDIRECTING
          <br />
          <span style={{ color: T.primary }}>TO CHECKOUT</span>
        </h1>
        <p style={{ fontFamily: T.sans, fontSize: "0.9rem", color: T.muted }}>
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        >
          PROCEED TO
          <br />
          <span style={{ color: T.primary }}>PAYMENT</span>
        </h1>
      </div>
