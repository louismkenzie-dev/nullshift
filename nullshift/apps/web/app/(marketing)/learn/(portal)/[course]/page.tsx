...
const COURSES: Record<
  string,
  {
    ...
    modules: {
      title: string;
      lessons: { slug: string; title: string; duration: string; free?: boolean }[];
    }[];
  }
> = {
  "ai-fundamentals": {
    ...
    description:
      "Understand how modern AI tools work, where they're headed, and how to evaluate them for your workflow. No technical background required.",
    modules: [
      {
  ...
  "workflow-automation": {
    ...
    description:
      "Connect your tools, eliminate repetitive tasks, and build automated systems that run without you.",
    modules: [
      {
        ...
        lessons: [
          ...
          {
            slug: "mapping-your-workflows",
            title: "Mapping your workflows",
            duration: "16 min",
          },
          {
            slug: "triggers-actions-conditions",
            title: "Triggers, actions and conditions",
            duration: "14 min",
          },
        ],
      },
      ...
      },
      {
        ...
        lessons: [
          {
            slug: "llms-in-workflows",
            title: "Using LLMs inside workflows",
            duration: "17 min",
          },
          {
            slug: "email-automation",
            title: "Email automation with AI triage",
            duration: "15 min",
          },
          {
          ...
          {
            slug: "monitoring-your-automations",
            title: "Monitoring and maintaining automations",
            duration: "12 min",
          },
        ],
      },
  ...
  "prompt-engineering": {
    ...
    description:
      "Get consistently great output from AI. Learn the patterns, structures, and techniques that actually work.",
    modules: [
      {
      ...
      <div className="max-w-5xl">
        ...
        >
          ...
          <span style={{ color: T.primary }}>
            {course.title.toUpperCase().replace(/ /g, "_")}
          </span>
        </div>
                ...
                {mod.lessons.map((lesson, li) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      >
                        <span
                          style={{ fontFamily: T.mono, fontSize: "9px", color: T.muted }}
                        >
