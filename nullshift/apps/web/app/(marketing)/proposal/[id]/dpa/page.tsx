...
export default async function ProposalDpaPage({
  params,
}: {
    ...
    <div style={{ minHeight: "100vh", background: T.bg, padding: "48px 24px" }}>
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <div
          ...
          style={{
            border: `1px solid ${accepted ? T.primary : T.borderStr}`,
            background: accepted ? `${T.primary}14` : T.surface,
            borderRadius: T.r.md,
          }}
        >
          <span
            style={{
              ...
              height: 8,
              borderRadius: "50%",
              background: accepted ? T.primary : T.muted,
              flexShrink: 0,
              marginTop: 6,
            }}
          />
          {accepted ? (
            ...
            >
              Accepted as part of proposal <strong>{proposalRef(id)}</strong> by{" "}
              <strong>{accepted.name}</strong> on {accepted.at}. This agreement is in
              force for the duration of the Services.
            </p>
          ) : (
            <p
              style={{
            ...
            >
              This agreement is part of your proposal — you don&apos;t sign it separately.
              Review it here, then{" "}
              <Link
                href={`/proposal/${id}`}
        ...
        <DpaTemplate
          ...
          specialCategory={{
            present: !!p.dpa_special_category,
            detail: p.dpa_special_category_detail ?? null,
          }}
          accepted={accepted}
        />
