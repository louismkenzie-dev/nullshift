      ...
      <main>
        ...
        >
          ...
          <Link
            ...
            style={{
              ...
              padding: "16px 20px",
              textDecoration: "none",
              boxShadow: `0 0 30px ${T.primary}14`,
            }}
          >
            <span
              style={{
            ...
            >
              Renting booking + records software per practitioner? Own it instead — build
              from £2,950, care from £49/mo, and take patient payments at a fraction.{" "}
              <span style={{ color: T.primary }}>See clinic pricing →</span>
            </span>
          </Link>
        </section>
        ...
        >
          <Reveal>
            ...
            >
              Start here. Self-serve learning for DIY-ers, plus our premium
              &ldquo;done-with-you&rdquo; Partner tier — we build it and teach you to own
              it in 12 months.
            </p>
          </Reveal>
        ...
        >
          <Reveal>
            <div>
              ...
              >
                Book a free 15-minute call — we&apos;ll work out the right plan and show
                you the system live. {BRAND_LINE}
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
