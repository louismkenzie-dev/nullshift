...
export function Fill({ children }: { children: React.ReactNode }) {
  return (
    <span
      title="To be confirmed before signing"
      style={{
  ...
  const specialCategoryCell = specialCategory?.present ? (
    ...
    <>
      ...
      {mode === "template" ? (
        <>
          {" "}
          <Fill>specify per engagement if applicable</Fill>
        </>
      ) : null}
    </>
  );
  ...
  return (
    <div>
      ...
      <P>
        ...
        {val(client.companyNumber, "client company number")}) whose registered office is
        at {val(client.registeredAddress, "client registered address")} (the
      ...
      <P>
        1.1 This Data Processing Agreement (&quot;DPA&quot;) governs the Processing of
        Personal Data by Nullshift on behalf of the Client in connection with the website
        development, hosting, maintenance and related services that Nullshift provides to
        the Client (the &quot;Services&quot;), as set out in the parties&apos; main
        services agreement or statement of work (the &quot;Principal Agreement&quot;).
      </P>
      <P>
        1.2 This DPA forms part of, and is subject to, the Principal Agreement. Where
        there is any conflict between this DPA and the Principal Agreement on the subject
        of data protection, this DPA prevails.
      </P>
      <P>
        1.3 The parties agree that, in respect of the Personal Data processed under the
        Services, the Client is the Controller and Nullshift is the Processor.
      </P>
      ...
      <UL
        items={[
          <>
            &quot;Data Protection Law&quot; means all laws applicable to the Processing of
            Personal Data under this DPA, including the UK GDPR, the Data Protection Act
            2018, the Data (Use and Access) Act 2025, and the Privacy and Electronic
            Communications Regulations 2003 (PECR), each as amended or replaced from time
            to time.
          </>,
          <>
            &quot;UK GDPR&quot; means Regulation (EU) 2016/679 as it forms part of the law
            of England and Wales, Scotland and Northern Ireland by virtue of the European
          ...
          <>
            &quot;Restricted Transfer&quot; means a transfer of Personal Data to a country
            or territory outside the United Kingdom that is subject to restrictions under
            Data Protection Law.
          </>,
          <>
            ...
            Standard Contractual Clauses, as issued by the Information Commissioner, or
            any successor mechanism.
          </>,
        ]}
      />
      ...
      <P>
        3.1 The subject matter, duration, nature and purpose of the Processing, the types
        of Personal Data, and the categories of Data Subjects are set out in Annex 1.
      </P>
      <P>
        3.2 Nullshift will Process the Personal Data only for the purposes of providing
        the Services and as described in Annex 1, and not for any of its own purposes.
      </P>

      <H2>4. Nullshift&apos;s obligations</H2>
      <P>Nullshift will:</P>
      <P>
        4.1 <B>Process only on instructions.</B> Process the Personal Data only on the
        Client&apos;s documented instructions, including the instructions set out in this
        DPA and the Principal Agreement, unless required to do otherwise by law (in which
        case Nullshift will, where legally permitted, inform the Client before
        Processing).
      </P>
      <P>
      ...
      <P>
        4.3 <B>Confidentiality.</B> Ensure that persons authorised to Process the Personal
      ...
      <P>
        ...
        measures set out in Annex 2 to ensure a level of security appropriate to the risk,
        in accordance with Article 32 UK GDPR.
      </P>
      <P>
        4.5 <B>Assist with Data Subject rights.</B> Taking into account the nature of the
        Processing, assist the Client by appropriate technical and organisational
        measures, insofar as possible, to respond to requests by Data Subjects exercising
        their rights under Data Protection Law (including access, rectification, erasure,
        restriction, portability and objection).
      </P>
      <P>
        4.6 <B>Assist with compliance.</B> Assist the Client in ensuring compliance with
        its obligations relating to security, Personal Data Breach notification, data
        protection impact assessments and prior consultation with the Information
        Commissioner, taking into account the nature of Processing and the information
        available to Nullshift.
      </P>
      <P>
        4.7 <B>Breach notification.</B> Notify the Client without undue delay, and in any
        event within 72 hours, after becoming aware of a Personal Data Breach affecting
        the Personal Data, and provide the Client with sufficient information to allow it
        to meet any obligations to report the breach to the Information Commissioner or
        affected Data Subjects.
      </P>
      <P>
        4.8 <B>Records and demonstration of compliance.</B> Make available to the Client
        all information reasonably necessary to demonstrate compliance with this DPA, and
        maintain written records of its Processing activities as required by Data
        Protection Law.
      </P>
      <P>
        4.9 <B>Audits.</B> Allow for and contribute to audits, including inspections,
        conducted by the Client or another auditor mandated by the Client, on reasonable
        prior written notice (and no more than once per year except where required by a
        regulator or following a Personal Data Breach), subject to reasonable
        confidentiality and security conditions.
      </P>
      ...
      <P>
        ...
        protection obligations substantially equivalent to those set out in this DPA, and
        remains fully liable to the Client for the performance of each
        Sub-processor&apos;s obligations.
      </P>
      <P>
        5.3 Nullshift will inform the Client of any intended addition or replacement of a
        Sub-processor at least 14 days in advance, giving the Client the opportunity to
        object on reasonable data protection grounds. If the Client objects and the
        parties cannot agree a resolution, either party may terminate the affected
        Services.
      </P>
      ...
      <P>
        ...
        without the Client&apos;s prior authorisation, except as already described in
        Annex 1 or Annex 3.
      </P>
      <P>
        ...
        configure hosting so that Personal Data is stored in a UK or European region where
        reasonably practicable.
      </P>

      <H2>7. Deletion and return of data</H2>
      <P>
        7.1 On termination or expiry of the Services, and at the Client&apos;s choice,
        Nullshift will delete or return all the Personal Data to the Client and delete
        existing copies, unless Data Protection Law requires continued storage.
      </P>
      <P>
        7.2 Nullshift will, on request, certify in writing that it has complied with this
        clause.
      </P>

      <H2>8. Liability</H2>
      <P>
        8.1 Each party&apos;s liability arising out of or related to this DPA is subject
        to the limitations and exclusions of liability set out in the Principal Agreement.
      </P>

      <H2>9. General</H2>
      <P>
        9.1 <B>Duration.</B> This DPA takes effect on the Effective Date and continues for
        as long as Nullshift Processes Personal Data on behalf of the Client.
      </P>
      <P>
        9.2 <B>Governing law.</B> This DPA is governed by the laws of England and Wales,
        and the parties submit to the exclusive jurisdiction of the courts of England and
        Wales.
      </P>
      <P>
      ...
      <Table
        ...
        rows={[
          ...
          [
            ...
            (personalDataTypes ?? "").trim() ? (
              <>{personalDataTypes}</>
            ) : mode === "proposal" ? (
              <Fill>types of personal data — to add</Fill>
            ) : (
              <>
                Typically names, email addresses, postal addresses, telephone numbers,
                account credentials, booking/order details, payment-related identifiers
                (not full card data), IP addresses, and any other data the Client&apos;s
                site collects. <Fill>confirm actual fields per engagement</Fill>
              </>
            ),
          ],
