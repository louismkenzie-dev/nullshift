/* Ported verbatim from Suffolk Tennis LTA — src/lib/lta.ts (main @ 281b548, read
   2026-09-11). Do not edit here; re-port when the client ships a change. */
...
export const LTA_AREAS: Array<{ name: string; descriptor: string }> = [
  ...
  {
    name: "Comfortable in Rally",
    descriptor: "Consistency, repeatable, contact point, tempo",
  },
  { name: "Chases Every Ball", descriptor: "Defending qualities, determined, adaptable" },
  {
    name: "Creative in Play",
    descriptor: "Skillfulness, chopper grip, feel, variety, adaptable",
  },
  { name: "Athletic Qualities", descriptor: "Agility, balance, coordination, speed" },
  {
    name: "Reads the Ball",
    descriptor: "Anticipation, perception, tennis specific movement",
  },
