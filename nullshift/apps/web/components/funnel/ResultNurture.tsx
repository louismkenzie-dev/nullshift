...
export function ResultNurture({
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="w-full">
      ...
      >
        <div style={{ fontFamily: T.mono, fontSize: "10px", letterSpacing: "0.16em", textTransform: "uppercase", color: T.muted, marginBottom: 10 }}>
          Free resource
        </div>
        ...
        <p className="mt-2" style={{ fontFamily: T.sans, fontSize: "0.9rem", lineHeight: 1.6, color: T.muted }}>
          On its way to your inbox{contact?.email ? <> at <span style={{ color: T.fg }}>{contact.email}</span></> : null} now — a practical checklist and templates to move forward today, plus the occasional genuinely useful tip. No spam, unsubscribe anytime.
        </p>

        <div className="mt-3 inline-flex items-center gap-2" style={{ fontFamily: T.mono, fontSize: "11px", letterSpacing: "0.04em", color: T.primary }}>
          <span aria-hidden>📨</span> Sent — check your inbox
        </div>
