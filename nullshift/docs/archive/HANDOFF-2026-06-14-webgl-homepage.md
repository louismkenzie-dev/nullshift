...
- The **preview screenshot tool returns solid black** for the WebGL + `position:sticky` + `filter:blur` composited section — and late in the session it returned black for _all_ pages. **Screenshots are unreliable here.**
