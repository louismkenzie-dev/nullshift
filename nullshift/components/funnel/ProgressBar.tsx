  ...
  return (
    ...
    >
      <div className="flex items-center justify-between" style={{ marginBottom: 8 }}>
        ...
        <span style={{ fontFamily: T.mono, fontSize: "10px", letterSpacing: "0.1em", color: T.primary }}>
          {Math.round(pct)}%
        </span>
      </div>
      <div style={{ height: 3, borderRadius: 999, background: T.surface2, overflow: "hidden" }}>
        <div
          style={{
            height: "100%",
            width: `${pct}%`,
